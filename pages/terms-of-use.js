      ...
      <div className="h-full w-screen py-10 px-12 md:px-[17rem]">
        <article className="prose max-w-none">
          ...
          <p>
            ...
            reference. coagent.co is a Social Networking Site. This website will
            hold public user profiles that are shared with others in a social
            media fashion. Users will be able to search for profiles by name.
            Nothing on this website is for sale at the moment. Privacy Your use
            of coagent.co is subject to CoAgent&apos;s Privacy Policy. Please
            review our Privacy Policy, which also governs the Site and informs
            users of our data collection practices. Electronic Communications
            Visiting coagent.co or sending emails to CoAgent constitutes
          ...
          <p>
            ...
            any other person or entity. You acknowledge that CoAgent is not
            responsible for third party access to your account that results from
            theft or misappropriation of your account. CoAgent and its
            associates reserve the right to refuse or cancel service, terminate
            accounts, or remove or edit content in our sole discretion. Children
            Under Thirteen CoAgent does not knowingly collect, either online or
            offline, personal information from persons under the age of
            thirteen. If you are under 18, you may use coagent.co only with
            permission of a parent or guardian. Links to Third Party Sites/Third
            Party Services coagent.co may contain links to other websites
            (&quot;Linked Sites&quot;). The Linked Sites are not under the
            control of CoAgent and CoAgent is not responsible for the contents
            ...
            CoAgent is providing these links to you only as a convenience, and
            the inclusion of any link does not imply endorsement by CoAgent of
            the site or any association with its operators. Certain services
            made available via coagent.co are delivered by third party sites and
            organizations. By using any product, service or functionality
            originating from the coagent.co domain, you hereby acknowledge and
            consent that CoAgent may share such information and data with any
            third party with whom CoAgent has a contractual relationship to
            provide the requested product, service or functionality on behalf of
            coagent.co users and customers. No Unlawful or Prohibited
            Use/Intellectual Property You are granted a non-exclusive,
            non-transferable, revocable license to access and use coagent.co
            strictly in accordance with these terms of use. As a condition of
            your use of the Site, you warrant to CoAgent that you will not use
            ...
            used on the Site, is the property of CoAgent or its suppliers and
            ...
            part, found on the Site. CoAgent content is not for resale. Your use
            ...
            permission of CoAgent and the copyright owner. You agree that you do
            ...
            property of CoAgent or our licensors except as expressly authorized
            by these Terms.
          </p>
          <p>
            Third Party Accounts You will be able to connect your CoAgent
            account to third party accounts. By connecting your CoAgent account
            to your third party account, you acknowledge and agree that you are
            ...
            party sites). If you do not want information about you to be shared
            in this manner, do not use this feature. International Users The
            Service is controlled, operated and administered by CoAgent from our
            ...
            laws. You agree that you will not use the CoAgent Content accessed
            through coagent.co in any country or in any manner prohibited by any
            applicable laws, restrictions or regulations. Indemnification You
            agree to indemnify, defend and hold harmless CoAgent, its officers,
            ...
            laws, rules or regulations. CoAgent reserves the right, at its own
            ...
            fully cooperate with CoAgent in asserting any available defenses.
            ...
            such dispute shall be resolved only by final and binding arbitration
          ...
          <p>
            ...
            AGAINST THE OTHER. Further, unless both you and CoAgent agree
            otherwise, the arbitrator may not consolidate more than one
            person&apos;s claims, and may not otherwise preside over any form of
            a representative or class proceeding. Liability Disclaimer THE
            ...
            COAGENT {/*CO*/} AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
            CHANGES IN THE SITE AT ANY TIME. COAGENT {/*CO*/} AND/OR ITS
            ...
            IS&quot; WITHOUT WARRANTY OR CONDITION OF ANY KIND. COAGENT {/*CO*/}{" "}
            ...
            IN NO EVENT SHALL COAGENT {/*CO*/} AND/OR ITS SUPPLIERS BE LIABLE
            ...
            EVEN IF COAGENT {/*CO*/} OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF
          ...
          <p>
            Termination/Access Restriction CoAgent reserves the right, in its
            ...
            exclusive jurisdiction and venue of courts in California in all
            ...
            limitation, this section. You agree that no joint venture,
            partnership, employment, or agency relationship exists between you
            and CoAgent as a result of this agreement or use of the Site.
            CoAgent&apos;s performance of this agreement is subject to existing
            laws and legal process, and nothing contained in this agreement is
            in derogation of CoAgent&apos;s right to comply with governmental,
            court and law enforcement requests or requirements relating to your
            use of the Site or information provided to or gathered by CoAgent
            ...
            constitutes the entire agreement between the user and CoAgent with
            ...
            between the user and CoAgent with respect to the Site. A printed
            ...
            documents be written in English. Changes to Terms CoAgent reserves
            the right, in its sole discretion, to change the Terms under which
            coagent.co is offered. The most current version of the Terms will
            supersede all previous versions. CoAgent encourages you to
            periodically review the Terms to stay informed of our updates.
          </p>
          <p>
            CoAgent welcomes your questions or comments regarding the Terms:
          </p>
          <p>
            CoAgent 2377 Crenshaw Blvd, Torrance, CA 90501 Email Address:
            legal@coagent.co Telephone number: 3109776834 Effective as of
            September 16, 2022
          </p>
        </article>
      </div>
...
TermsOfUse.PageLayout = HomepageLayout;
